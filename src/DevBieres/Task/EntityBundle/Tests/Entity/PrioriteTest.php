...
class PrioriteTest extends BaseTestCase
{
  ...
  */
  ...
  public function testOrderBy() {
    ...
    // --> Profite pour tester les services spécifiques :)
    $p = $this->getManager()->getPrioriteHaute();
    $this->assertEquals("Haute", $p->getLibelle());
    $p = $this->getManager()->getPrioriteNormale();
    $this->assertEquals("Normal", $p->getLibelle());
    $p = $this->getManager()->getPrioriteBasse();
    $this->assertEquals("Basse", $p->getLibelle());
