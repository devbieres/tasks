...
class TacheSimpleTest extends BaseTestCase
{
  ...
  public function setup() {
    ...
    $this->pr1->setLibelle("Normal"); $this->pr1->setNiveau(0); $this->getPrioriteManager()->persist($this->pr1);
    $this->pr2 = $this->getPrioriteManager()->getNew();
    $this->pr2->setLibelle("Haute"); $this->pr2->setNiveau(1); $this->getPrioriteManager()->persist($this->pr2);
